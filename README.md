...
Download the repository. Move the sliders.js and styles.css into your project folder. To link the styles to your project insert the following code into your index.html header.
```
